...
contract Vault is ReentrancyGuard {
    ...
    function swapAndDeposit(address _tokenIn, uint256 amountIn, address swapper, bytes calldata data)
        external
        nonReentrant
    {
...
// WETH in different chains .safeTransferFrom()
// External Contracts
// call to address(this)
// call to tokens
// call to external contracts used by the contract
// slippage
